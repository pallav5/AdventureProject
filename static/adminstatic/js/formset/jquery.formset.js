...
;(function($) {
    ...
    $.fn.formset.defaults = {
        ...
        addCssClass: '  btn btn-sm btn-success add-row',          // CSS class applied to the add link
        deleteCssClass: ' btn btn-sm btn-danger delete-row',    // CSS class applied to the delete link
